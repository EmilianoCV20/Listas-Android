...
public class ListaConCheckboxesActivity extends AppCompatActivity {
    ...
    private String [] insectos = { "Mantis", "Escarabajo", "Abeja", "Avispa", "Polilla", "Gusano",
                                   "Mariquita", "Chinche", "Caracol", "Mosca", "Mariposa" } ;
    ...
    public void btnElementosSeleccionadosClick ( View v ) {
        ...
        if ( seleccionados.isEmpty() ) {
            Toast.makeText( this, "No hay nada seleccionado", Toast.LENGTH_SHORT )
                    .show();
        } else {
            Toast.makeText( this, "Seleccion: " + seleccionados, Toast.LENGTH_SHORT )
                    .show();
        }
